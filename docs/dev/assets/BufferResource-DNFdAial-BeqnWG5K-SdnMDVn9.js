import{P as c,y as U,H as g,b as m,m as I,L as M,a as h,q as _}from"./index-Da2_YtDe.js";const x={name:"local-uniform-bit",vertex:{header:`
...
`);return new Function("uv","data","dataInt32","offset",f)}function v(e,t){return`
    ...
    `}const k={f32:`
        ...
        for (let i = 0; i < 16; i++) {
            data[offset + i] = v[i];
        }`,"mat3x2<f32>":v(3,2),"mat4x2<f32>":v(4,2),"mat2x3<f32>":v(2,3),"mat4x3<f32>":v(4,3),"mat2x4<f32>":v(2,4),"mat3x4<f32>":v(3,4)},D={...k,"mat2x2<f32>":`
        data[offset] = v[0];
        data[offset + 1] = v[1];
        data[offset + 2] = v[2];
        data[offset + 3] = v[3];
    `};class G extends M{constructor({buffer:t,offset:a,size:o}){super(),this.uid=h("buffer"),this._resourceType="bufferResource",this._touched=0,this._resourceId=h("resource"),this._bufferResource=!0,this.destroyed=!1,this.buffer=t,this.offset=a|0,this.size=o,this.buffer.on("change",this.onBufferChange,this)}onBufferChange(){this._resourceId=h("resource"),this.emit("change",this)}destroy(t=!1){this.destroyed=!0,t&&this.buffer.destroy(),this.emit("change",this),this.buffer=null,this.removeAllListeners()}}export{w as A,D,A as E,O as F,G,R as O,S as R,C as S,d,p as h,k,E as w,x};
